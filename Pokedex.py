...
sv_pokemon_height = tkb.StringVar(value="6.9kg")
sv_pokemon_weight = tkb.StringVar(value="0.7m")
...
pokemon_description = tkb.Label(root, textvariable=sv_pokemon_description, wraplength=325, font=('Pokémon Red/Blue/Green/Yellow Edition Font', 30))
