...
pokedex_data = [('001', 'BULBIZARRE', 'GRAINE', '0,7m', '6,9kg', 'Il a une étrange graine plantée sur son dos. Elle grandit avec lui depuis la naissance.', '/Users/fnk/PycharmProjects/Pokedex/src/src/sprites/001.png', '/Users/fnk/PycharmProjects/Pokedex/src/sound/001.wav'),
('002', 'HERBIZARRE', 'GRAINE', '1,0m', '13,0kg', 'Son bulbe dorsal devient si gros qu''il ne peut plus se tenir sur ses membres postérieurs.', '/Users/fnk/PycharmProjects/Pokedex/src/sprites/002.png/Users/fnk', '/Users/fnk/PycharmProjects/Pokedex/src/sound/002.wav'),
...
('023', 'ABO', 'SERPENT', '2,0m', '6,9kg', 'Il se déplace en silence pour dévorer des œufs de Roucool ou de Piafabec.', '/Users/fnk/PycharmProjects/Pokedex/src/sprites/023.png', '/Users/fnk/PycharmProjects/Pokedex/src/sound/023.wav'),
...
('087', 'LAMANTINE', 'OTARIE', '1,7m', '120,0kg', 'Il emmagasine la chaleur dans son corps. Il peut nager dans l''eau glacée à plus de 8 nœuds.', '/Users/fnk/PycharmProjects/Pokedex/src/sprites/087.png', '/Users/fnk/PycharmProjects/Pokedex/src/sound/087.wav'),
...
('102', 'NOEUNOEUF', 'ŒUF', '0,4m', '2,5kg', 'Souvent pris pour des Œufs, ils attaquent en groupe comme un essaim.', '/Users/fnk/PycharmProjects/Pokedex/src/sprites/102.png', '/Users/fnk/PycharmProjects/Pokedex/src/sound/102.wav'),
...
('107', 'TYGNON', 'PUNCHEUR', '1,4m', '50,2kg', 'Il distribue des séries de coups de poing rapide comme l''éclair, invisibles à l''œil nu.', '/Users/fnk/PycharmProjects/Pokedex/src/sprites/107.png', '/Users/fnk/PycharmProjects/Pokedex/src/sound/107.wav'),
...
('113', 'LEVEINARD', 'ŒUF', '1,1m', '34,6kg', 'Un Pokémon rare et difficile à capturer qui porte chance et bien-être à son possesseur.', '/Users/fnk/PycharmProjects/Pokedex/src/sprites/113.png', '/Users/fnk/PycharmProjects/Pokedex/src/sound/113.wav'),
...
('121', 'STAROSS', 'MYSTERIEUX', '1,1m', '80,0kg', 'Son cœur brille des couleurs de l''arc-en-ciel. On dit que c''est une pierre précieuse.', '/Users/fnk/PycharmProjects/Pokedex/src/sprites/121.png', '/Users/fnk/PycharmProjects/Pokedex/src/sound/121.wav'),
...
sv_search = tkb.StringVar(value="PIKACHU")
sv_pokemon_index = tkb.StringVar(value="")
sv_pokemon_name = tkb.StringVar(value="")
sv_pokemon_category = tkb.StringVar(value="")
sv_pokemon_height = tkb.StringVar(value="")
sv_pokemon_weight = tkb.StringVar(value="")
sv_pokemon_description = tkb.StringVar(value="")
sv_pokemon_spritepath = tkb.StringVar(value="")
sv_pokemon_crypath = tkb.StringVar(value="")
...
btn_search = tk.Button(root, image=icn_search, autostyle=False)
...
btn_previous = tk.Button(root, image=icn_previous, autostyle=False)
...
btn_next =tk.Button(root, image=icn_next, autostyle=False)
...
pokemon_name = tkb.Label(root, text='BULBIZARRE', font=('Pokémon Red/Blue/Green/Yellow Edition Font', 30))
pokemon_name.place(x=175, y=5)

pokemon_category = tkb.Label(root, text='GRAINE', font=('Pokémon Red/Blue/Green/Yellow Edition Font', 30))
...
pokemon_height = tkb.Label(root, text='0.7m', font=('Pokémon Red/Blue/Green/Yellow Edition Font', 30))
...
pokemon_weight = tkb.Label(root, text='6.9kg', font=('Pokémon Red/Blue/Green/Yellow Edition Font', 30))
pokemon_weight.place(x=240, y=110)

pokemon_img = Image.open('/Users/fnk/PycharmProjects/Pokedex/src/sprites/001.png')
...
pokemon_sprite.place(x=15, y=10)

pokemon_index_lbl = tkb.Label(root, text='No.', font=('Pokémon Red/Blue/Green/Yellow Edition Font', 24))
pokemon_index_lbl.place(x=25, y=115)

pokemon_index = tkb.Label(root, text='001', font=('Pokémon Red/Blue/Green/Yellow Edition Font', 28))
pokemon_index.place(x=65, y=112)

pokemon_description = tkb.Label(root, text='Il a une étrange graine plantée sur son dos. Elle grandit avec lui depuis la naissance.', wraplength=325, font=('Pokémon Red/Blue/Green/Yellow Edition Font', 30))
